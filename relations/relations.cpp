...
// 2. Первый объект в один момент времени может быть свзан с несколькими объектами второго класса
// 3. Первый объект не управляет жизнью второго объекта (и наоборот)
// 4. Первый объект может знать о сущесвовании второго (и наоборот)
...
////// --- однонаправленная n-арная рефлексивная ассоциация
//
//class Category
//{
//public:
...
//// --- двунаправленная n-арная рефлексивная ассоциация
//#include <vector>
//class Category
//{
//public:
